...
{
    /// <summary>Interface for metadata provider query service</summary>
    public interface IMetadataProviderQueryService
    {
        /// <summary>Retrieves entities for the given service</summary>
        ...
        /// <summary>Retrieves option sets for the given service</summary>
        /// <param name="service">Service to query</param>
        /// <returns>An OptionSetMetadataBase array</returns>
        OptionSetMetadataBase[] RetrieveOptionSets(IOrganizationService service);

        /// <summary>Retrieves SDK requests for the given service</summary>
        /// <param name="service">Service to query</param>
