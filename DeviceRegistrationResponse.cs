...
namespace Microsoft.Crm.Services.Utility
{
    ...
    public sealed class DeviceRegistrationResponse
    {
        ...
        /// <summary>Gets or sets the device registration puid</summary>
        [XmlElement("puid")]
        public string Puid { get; set; }

        /// <summary>Gets or sets the device registration error</summary>
        [XmlElement("Error")]
        public DeviceRegistrationResponseError Error { get; set; }

        /// <summary>Gets or sets the device registration error sub code</summary>
