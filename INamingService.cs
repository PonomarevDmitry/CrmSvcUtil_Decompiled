...
namespace Microsoft.Crm.Services.Utility
{
    ...
    {
        /// <summary>Returns a name for the OptionSet being generated.</summary>
        string GetNameForOptionSet(
          EntityMetadata entityMetadata,
          OptionSetMetadataBase optionSetMetadata,
          IServiceProvider services);

        /// <summary>Retrieves a name for the Option being generated.</summary>
        string GetNameForOption(
          OptionSetMetadataBase optionSetMetadata,
          OptionMetadata optionMetadata,
          IServiceProvider services);

        /// <summary>Retrieves a name for the Entity being generated.</summary>
        string GetNameForEntity(EntityMetadata entityMetadata, IServiceProvider services);

        /// <summary>Retrieves a name for the Attribute being generated.</summary>
        ...
        /// <summary>Retrieves a name for a set of entities.</summary>
        string GetNameForEntitySet(EntityMetadata entityMetadata, IServiceProvider services);

        /// <summary>Retrieves a name for the MessagePair being generated.</summary>
