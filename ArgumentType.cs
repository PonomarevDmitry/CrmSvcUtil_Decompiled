...
{
    /// <remarks>Type of command line argument represented.</remarks>
    [Flags]
    internal enum ArgumentType
    {
        /// <summary>Argument is optional.</summary>
        Optional = 1,
        /// <summary>Argument is required.</summary>
        Required = 2,
        /// <summary>The argument may appear multiple times.</summary>
        Multiple = 4,
        /// <summary>
